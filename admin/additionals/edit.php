...
if ($_POST) {
    ...
    if (empty($name)) {
        ...
        try {
            ...
            $message = 'Error al actualizar el adicional: ' . $e->getMessage();
            $messageType = 'danger';
        }
    }
}
...
<head>
    ...
    <title>Editar Adicional - Administración</title>
                        ...
                        <form method="POST" action="">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" 
                                               value="<?= htmlspecialchars($additional['name']) ?>"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="price" name="price" 
                                                   value="<?= number_format($additional['price'], 2, '.', '') ?>"
                                        ...
                                        <select class="form-select" id="category_id" name="category_id">
                                            ...
                                            <?php foreach ($categories as $category): ?>
                                                <option value="<?= $category['id'] ?>" 
                                                        <?= $additional['category_id'] == $category['id'] ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status">
                                            <option value="active" <?= $additional['status'] === 'active' ? 'selected' : '' ?>>
                                                Activo
                                            </option>
                                            <option value="inactive" <?= $additional['status'] === 'inactive' ? 'selected' : '' ?>>
                                                Inactivo
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" 
                                          ...
                                          placeholder="Descripción opcional del adicional..."><?= htmlspecialchars($additional['description'] ?? '') ?></textarea>
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-1"><strong>ID:</strong> <?= $additional['id'] ?></p>
                                <p class="mb-1"><strong>Creado:</strong> <?= date('d/m/Y H:i', strtotime($additional['created_at'])) ?></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-1"><strong>Última actualización:</strong> 
                                    <?= isset($additional['updated_at']) && $additional['updated_at'] ? date('d/m/Y H:i', strtotime($additional['updated_at'])) : 'Nunca' ?>
                                </p>
                                <p class="mb-1"><strong>Estado actual:</strong> 
                                    <span class="badge bg-<?= $additional['status'] === 'active' ? 'success' : 'secondary' ?>">
